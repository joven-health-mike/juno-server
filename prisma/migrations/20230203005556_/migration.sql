...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_schoolAdminAssignedSchoolId_fkey" FOREIGN KEY ("schoolAdminAssignedSchoolId") REFERENCES "School"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_schoolStaffAssignedSchoolId_fkey" FOREIGN KEY ("schoolStaffAssignedSchoolId") REFERENCES "School"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_studentAssignedSchoolId_fkey" FOREIGN KEY ("studentAssignedSchoolId") REFERENCES "School"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_counselorUserId_fkey" FOREIGN KEY ("counselorUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "School"("id") ON DELETE SET NULL ON UPDATE CASCADE;
